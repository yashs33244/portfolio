        ...
        <div className="col-span-2 space-y-6">
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              from India, currently pursuing my Bachelor of Technology degree at
              Indian Institute of Information Technology Una. My journey in
            ...
            <p className="text-muted-foreground mb-4">
              ...
              Mandi, focusing on continuous authentication systems and compound
              olfaction using Graph Neural Networks.
            </p>
            <p className="text-muted-foreground">
              ...
              problem-solving, regularly participating in contests on platforms
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              ...
              in hackathons, and contributing to open-source projects. I'm also
              interested in financial markets and enjoy reading about economics
